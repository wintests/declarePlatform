...
<title>用户管理界面</title>
	...
	<script type="text/javascript">
		...
		function optionFormatter(value, row, index) {
			return [
	            "<a href='javascript:void(0);' onclick='change(" + index + ")'><img src='${pageContext.request.contextPath }/jquery-easyui-1.3.4/themes/usericons/edit.png'/>编辑状态</a>&nbsp;&nbsp;&nbsp;",  
	        ];
		}
		...
		function save() {
			$("#fm").form("submit", {
				...
				success : function(data) {
					...
					if (data.state) {
						$.messager.alert("系统提示", "编辑状态成功");
						$("#fm").form("reset");
						$("#dlg").dialog("close"); //关闭对话框
						$("#dg").datagrid("unselectAll");	//关闭对话框时取消所选择的行记录
						$("#dg").datagrid("reload"); //刷新一下
					} else {
						$.messager.alert("系统提示", "编辑状态失败");
						return;
					}
				}
			});
	...
	<body>
		...
		<div id="dlg" class="easyui-dialog"
			style="width:350px; height:150px; padding:10px 20px"
